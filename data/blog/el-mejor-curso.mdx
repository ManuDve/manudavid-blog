...
draft: false
summary: 'Cómo elegir el mejor curso para aprender un determinado lenguaje de programación, tecnología o software'
...
- ¿Busca una certificación? **Consigue referencias de su validez**.
- ¿No tienes claro qué necesitas? _Entonces..._
...
Con la experiencia podrás ir aprendiendo a optimizar tus procesos, ordenar tu código, escribir más limpio, comenzarás a entender por qué son útiles los patrones de diseño, por qué se utilizan convenciones, el porqué de la existencia de los algoritmos. Finalmente, se hará más claro el tipo de curso que buscas.
